...
(function () {
  ...
  function renderDeadlines(target, items, showPast) {
    if (!items.length) {
      target.innerHTML = '<p class="empty">Nothing scheduled yet. Add entries to <code>assets/data.js</code>.</p>';
      return;
    }
  ...
  if (upcoming) {
    ...
    if (!soon.length) {
      upcoming.innerHTML = '<p class="empty">Nothing coming up. Either you\'re clear, or <code>assets/data.js</code> needs updating.</p>';
    } else {
